      ...
      <DrawerPopup className={popupClass}>
        <DrawerContent className="flex h-full flex-col">
          ...
          <div className="mt-8 flex-1 space-y-6 overflow-y-auto">
            ...
            <Section title="Audio">
              <Toggle
                description="Synth key tap sounds"
                ...
                <SubDrawerRow
                  ...
                  preview={
                    <span className="text-[11px]">
                      {STROKE_SOUNDS.find((s) => s.id === strokeSound)?.label ?? "Original"}
                    </span>
                  }
                  swipe={swipe}
                  title="Stroke sound"
                  ...
                  <div className="space-y-1">
                    {STROKE_SOUNDS.map((snd) => (
                      <button
                        ...
                        key={snd.id}
                        onClick={() => setStrokeSound(snd.id)}
                        type="button"
                      >
                        <span className="text-foreground text-xs">{snd.label}</span>
                        {snd.type === "sprite" && (
                          <span className="text-[9px] text-muted-foreground/40">per-key</span>
                        )}
                        {strokeSound === snd.id && (
              ...
              <Toggle
                description="Buzz on wrong keystrokes"
                enabled={faahMode}
                label="Error buzz"
              ...
              {faahMode && (
                <SubDrawerRow
                  ...
                  preview={
                    <span className="text-[11px]">
                      {FAAH_SOUNDS.find((s) => s.id === faahSound)?.label ?? "Buzz"}
                    </span>
                  }
                  swipe={swipe}
                  title="Error sound"
