...
export const TEST_MODE_STORAGE_KEY = "si-test-mode";
export const TIME_OPTION_STORAGE_KEY = "si-time-option";
export const WORD_OPTION_STORAGE_KEY = "si-word-option";
export const QUOTE_LENGTH_STORAGE_KEY = "si-quote-length";
export const PUNCTUATION_STORAGE_KEY = "si-punctuation";
export const NUMBERS_STORAGE_KEY = "si-numbers";
export const DIFFICULTY_STORAGE_KEY = "si-difficulty";
